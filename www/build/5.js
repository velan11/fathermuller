...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StudTimetablePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
 ...
 */
var StudTimetablePage = /** @class */ (function () {
    function StudTimetablePage(authService, navCtrl, navParams, photoViewer, file) {
    ...
    // ionViewDidEnter() {}
    StudTimetablePage.prototype.viewPhoto = function () {
        var _this = this;
        var imageName = "TimeSchedule .jpg";
    ...
    StudTimetablePage.prototype.ionViewDidLoad = function () {
        this.getAttdc_info();
        console.log("ionViewDidLoad TimeTablePage");
    };
    StudTimetablePage.prototype.prevSlide = function () {
        this.slides.slideTo(this.slides.getActiveIndex() - 1, 500);
    };
    StudTimetablePage.prototype.nextSlide = function () {
        this.slides.slideTo(this.slides.getActiveIndex() + 1, 500);
    };
    StudTimetablePage.prototype.getAttdc_info = function () {
        var _this = this;
        var getStudentsUrl = "course-time-table";
        ...
        this.authService.getStudentData(getStudentsUrl).subscribe(function (data) {
            ...
            console.log("timetable: ", _this.responseData);
            _this.timeTableInfo = _this.responseData;
            _this.Monday_Data = _this.responseData.data[0].item;
            _this.Tuesdy_data = _this.responseData.data[1].item;
            _this.Wensdy_data = _this.responseData.data[2].item;
            _this.Thrsdy_data = _this.responseData.data[3].item;
            _this.Frisdy_data = _this.responseData.data[4].item;
            _this.Satsdy_data = _this.responseData.data[5].item;
            _this.Sundy_data = _this.responseData.data[6].item;
            console.log("dumm", _this.dumm);
            for (var y = 0; y < _this.responseData.data.length; y++) { }
            //  this.Tuesdy_data = this.responseData.data
            console.log("response", _this.Monday_Data);
            _this.reposDat = _this.responseData.data;
            for (var j = 0; j <= 5; j++) {
                console.log("repos data", _this.reposDat[0].item[j].from_time);
                //  this.wholedata.push(
                //    {name:this.reposDat[0].item[j]});
                // console.log('data',this.wholedata);
            }
            for (var i = 0; i < _this.reposDat.length; i++) {
                console.log("Date ", _this.reposDat[i].data);
            }
    ...
    StudTimetablePage.prototype.back = function () {
        this.navCtrl.pop();
    };
    __decorate([
    ...
    ], StudTimetablePage.prototype, "slides", void 0);
    StudTimetablePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-stud-timetable",template:/*ion-inline-start:"/home/sushmitha/dontdelete/velan/medical-app/src/pages/student/stud-timetable/stud-timetable.html"*/'<!--\n  Generated template for the StudTimetablePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-toolbar>\n    <ion-buttons left>\n      <button ion-button icon-only menuToggle>\n        <ion-icon name="menu" style="color:white"></ion-icon>\n      </button>\n    </ion-buttons>\n\n    <ion-title>Class schedule</ion-title>\n    <ion-buttons right (click)="back()">\n      <button ion-button icon-only>\n        <ion-icon\n          ios="ios-arrow-back"\n          md="md-arrow-back"\n          style="color:white"\n        ></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n<ion-content>\n  <h2 text-center style="margin-top: 25px;">Class schedule</h2>\n  <img\n    style="margin-top: 25px;"\n    src="../../../assets/images/TimeSchedule .jpg"\n    (click)="viewPhoto()"\n  />\n  <p\n    style="color: #5282af;font-size: 11px;text-align: right;\n        margin-right: 15px;"\n  >\n    *Click to View notice and SHARE\n  </p>\n</ion-content>\n<!-- <ion-content *ngIf="responseData" class="content-page">\n  <img *ngIf="responseData.data.length <=0" class="img1" src="../../assets/imgs/speaking.jpg" width="100%" height="20%">\n  <img src="../../../assets/images/TimeSchedule .jpg" (click)="viewPhoto()" />\n  <div style="display: none;">\n    <div *ngIf="responseData.data.length <= 0" class="No_data">\n      <ion-icon name="alert"></ion-icon> &nbsp;No Data to Display..!\n    </div>\n    <ion-slides\n      initialSlide="{{ indexSlideno }}"\n      class="slides2"\n      *ngIf="responseData.data.length >= 0"\n    >\n      <ion-slide>\n        <div class="dayName">\n          <ion-grid>\n            <ion-row>\n              <ion-col>\n                <button ion-button class="left_arrow" (click)="prevSlide()">\n                  <ion-icon name="arrow-dropleft"></ion-icon>\n                </button>\n              </ion-col>\n              <ion-col>\n                Monday\n              </ion-col>\n              <ion-col>\n                <button ion-button class="arrow" (click)="nextSlide()">\n                  <ion-icon name="arrow-dropright"></ion-icon>\n                </button>\n              </ion-col>\n            </ion-row>\n          </ion-grid>\n        </div>\n        <mat-grid-list cols="3" rowHeight="5:2" class="gridlist" padding>\n          <mat-grid-tile class="peroid" color="teal">Peroid</mat-grid-tile>\n          <mat-grid-tile class="time" color="teal">Time</mat-grid-tile>\n          <mat-grid-tile class="subject" color="teal">Subject</mat-grid-tile>\n        </mat-grid-list>\n\n        <mat-grid-list\n          cols="3"\n          rowHeight="5:2"\n          *ngFor="let d of Monday_Data; let i = index"\n        >\n          <mat-grid-tile class="d_id">{{ i + 1 }}</mat-grid-tile>\n          <mat-grid-tile class="d_time"\n            >{{ d.from_time }}-{{ d.end_time }}</mat-grid-tile\n          >\n          <mat-grid-tile class="d_sub">{{ d.subName }}</mat-grid-tile>\n        </mat-grid-list>\n        <div class="footer">\n          <p></p>\n        </div>\n      </ion-slide>\n      <ion-slide>\n        <div class="dayName">\n          <ion-grid>\n            <ion-row>\n              <ion-col>\n                <button ion-button class="left_arrow" (click)="prevSlide()">\n                  <ion-icon name="arrow-dropleft"></ion-icon>\n                </button>\n              </ion-col>\n              <ion-col>\n                Tuesday\n              </ion-col>\n              <ion-col>\n                <button ion-button class="arrow" (click)="nextSlide()">\n                  <ion-icon name="arrow-dropright"></ion-icon>\n                </button>\n              </ion-col>\n            </ion-row>\n          </ion-grid>\n        </div>\n        <mat-grid-list cols="3" rowHeight="5:2" class="gridlist" padding>\n          <mat-grid-tile class="peroid" color="teal">Peroid</mat-grid-tile>\n          <mat-grid-tile class="time" color="teal">Time</mat-grid-tile>\n          <mat-grid-tile class="subject" color="teal">Subject</mat-grid-tile>\n        </mat-grid-list>\n\n        <mat-grid-list\n          cols="3"\n          rowHeight="5:2"\n          *ngFor="let d of Tuesdy_data; let i = index"\n        >\n          <mat-grid-tile class="d_id">{{ i + 1 }}</mat-grid-tile>\n          <mat-grid-tile class="d_time"\n            >{{ d.from_time }}-{{ d.end_time }}</mat-grid-tile\n          >\n          <mat-grid-tile class="d_sub">{{ d.subName }}</mat-grid-tile>\n        </mat-grid-list>\n        <div class="footer">\n          <p></p>\n        </div>\n      </ion-slide>\n      <ion-slide>\n        <div class="dayName">\n          <ion-grid>\n            <ion-row>\n              <ion-col>\n                <button ion-button class="left_arrow" (click)="prevSlide()">\n                  <ion-icon name="arrow-dropleft"></ion-icon>\n                </button>\n              </ion-col>\n              <ion-col>\n                Wednesday\n              </ion-col>\n              <ion-col>\n                <button ion-button class="arrow" (click)="nextSlide()">\n                  <ion-icon name="arrow-dropright"></ion-icon>\n                </button>\n              </ion-col>\n            </ion-row>\n          </ion-grid>\n        </div>\n        <mat-grid-list cols="3" rowHeight="5:2" class="gridlist" padding>\n          <mat-grid-tile class="peroid" color="teal">Peroid</mat-grid-tile>\n          <mat-grid-tile class="time" color="teal">Time</mat-grid-tile>\n          <mat-grid-tile class="subject" color="teal">Subject</mat-grid-tile>\n        </mat-grid-list>\n\n        <mat-grid-list\n          cols="3"\n          rowHeight="5:2"\n          *ngFor="let d of Wensdy_data; let i = index"\n        >\n          <mat-grid-tile class="d_id">{{ i + 1 }}</mat-grid-tile>\n          <mat-grid-tile class="d_time"\n            >{{ d.from_time }}-{{ d.end_time }}</mat-grid-tile\n          >\n          <mat-grid-tile class="d_sub">{{ d.subName }}</mat-grid-tile>\n        </mat-grid-list>\n        <div class="footer">\n          <p></p>\n        </div>\n      </ion-slide>\n      <ion-slide>\n        <div class="dayName">\n          <ion-grid>\n            <ion-row>\n              <ion-col>\n                <button ion-button class="left_arrow" (click)="prevSlide()">\n                  <ion-icon name="arrow-dropleft"></ion-icon>\n                </button>\n              </ion-col>\n              <ion-col>\n                Thursday\n              </ion-col>\n              <ion-col>\n                <button ion-button class="arrow" (click)="nextSlide()">\n                  <ion-icon name="arrow-dropright"></ion-icon>\n                </button>\n              </ion-col>\n            </ion-row>\n          </ion-grid>\n        </div>\n        <mat-grid-list cols="3" rowHeight="5:2" class="gridlist" padding>\n          <mat-grid-tile class="peroid" color="teal">Peroid</mat-grid-tile>\n          <mat-grid-tile class="time" color="teal">Time</mat-grid-tile>\n          <mat-grid-tile class="subject" color="teal">Subject</mat-grid-tile>\n        </mat-grid-list>\n\n        <mat-grid-list\n          cols="3"\n          rowHeight="5:2"\n          *ngFor="let d of Thrsdy_data; let i = index"\n        >\n          <mat-grid-tile class="d_id">{{ i + 1 }}</mat-grid-tile>\n          <mat-grid-tile class="d_time"\n            >{{ d.from_time }}-{{ d.end_time }}</mat-grid-tile\n          >\n          <mat-grid-tile class="d_sub">{{ d.subName }}</mat-grid-tile>\n        </mat-grid-list>\n        <div class="footer">\n          <p></p>\n        </div>\n      </ion-slide>\n      <ion-slide>\n        <div class="dayName">\n          <ion-grid>\n            <ion-row>\n              <ion-col>\n                <button ion-button class="left_arrow" (click)="prevSlide()">\n                  <ion-icon name="arrow-dropleft"></ion-icon>\n                </button>\n              </ion-col>\n              <ion-col>\n                Friday\n              </ion-col>\n              <ion-col>\n                <button ion-button class="arrow" (click)="nextSlide()">\n                  <ion-icon name="arrow-dropright"></ion-icon>\n                </button>\n              </ion-col>\n            </ion-row>\n          </ion-grid>\n        </div>\n        <mat-grid-list cols="3" rowHeight="5:2" class="gridlist" padding>\n          <mat-grid-tile class="peroid" color="teal">Peroid</mat-grid-tile>\n          <mat-grid-tile class="time" color="teal">Time</mat-grid-tile>\n          <mat-grid-tile class="subject" color="teal">Subject</mat-grid-tile>\n        </mat-grid-list>\n\n        <mat-grid-list\n          cols="3"\n          rowHeight="5:2"\n          *ngFor="let d of Frisdy_data; let i = index"\n        >\n          <mat-grid-tile class="d_id">{{ i + 1 }}</mat-grid-tile>\n          <mat-grid-tile class="d_time"\n            >{{ d.from_time }}-{{ d.end_time }}</mat-grid-tile\n          >\n          <mat-grid-tile class="d_sub">{{ d.subName }}</mat-grid-tile>\n        </mat-grid-list>\n        <div class="footer">\n          <p></p>\n        </div>\n      </ion-slide>\n      <ion-slide>\n        <div class="dayName">\n          <ion-grid>\n            <ion-row>\n              <ion-col>\n                <button ion-button class="left_arrow" (click)="prevSlide()">\n                  <ion-icon name="arrow-dropleft"></ion-icon>\n                </button>\n              </ion-col>\n              <ion-col>\n                Saturday\n              </ion-col>\n              <ion-col>\n                <button ion-button class="arrow" (click)="nextSlide()">\n                  <ion-icon name="arrow-dropright"></ion-icon>\n                </button>\n              </ion-col>\n            </ion-row>\n          </ion-grid>\n        </div>\n        <mat-grid-list cols="3" rowHeight="5:2" class="gridlist" padding>\n          <mat-grid-tile class="peroid" color="teal">Peroid</mat-grid-tile>\n          <mat-grid-tile class="time" color="teal">Time</mat-grid-tile>\n          <mat-grid-tile class="subject" color="teal">Subject</mat-grid-tile>\n        </mat-grid-list>\n\n        <mat-grid-list\n          cols="3"\n          rowHeight="5:2"\n          *ngFor="let d of Satsdy_data; let i = index"\n        >\n          <mat-grid-tile class="d_id">{{ i + 1 }}</mat-grid-tile>\n          <mat-grid-tile class="d_time"\n            >{{ d.from_time }}-{{ d.end_time }}</mat-grid-tile\n          >\n          <mat-grid-tile class="d_sub">{{ d.subName }}</mat-grid-tile>\n        </mat-grid-list>\n        <div class="footer">\n          <p></p>\n        </div>\n      </ion-slide>\n      <ion-slide>\n        <div class="dayName">\n          <ion-grid>\n            <ion-row>\n              <ion-col>\n                <button ion-button class="left_arrow" (click)="prevSlide()">\n                  <ion-icon name="arrow-dropleft"></ion-icon>\n                </button>\n              </ion-col>\n              <ion-col>\n                Sunday\n              </ion-col>\n              <ion-col> </ion-col>\n            </ion-row>\n          </ion-grid>\n        </div>\n        <mat-grid-list cols="3" rowHeight="5:2" class="gridlist" padding>\n          <mat-grid-tile class="peroid" color="teal">Peroid</mat-grid-tile>\n          <mat-grid-tile class="time" color="teal">Time</mat-grid-tile>\n          <mat-grid-tile class="subject" color="teal">Subject</mat-grid-tile>\n        </mat-grid-list>\n\n        <mat-grid-list\n          cols="3"\n          rowHeight="5:2"\n          *ngFor="let d of Sundy_data; let i = index"\n        >\n          <mat-grid-tile class="d_id">{{ i + 1 }}</mat-grid-tile>\n          <mat-grid-tile class="d_time"\n            >{{ d.from_time }}-{{ d.end_time }}</mat-grid-tile\n          >\n          <mat-grid-tile class="d_sub">{{ d.subName }}</mat-grid-tile>\n        </mat-grid-list>\n        <div class="footer">\n          <p></p>\n        </div>\n      </ion-slide>\n    </ion-slides>\n  </div>\n</ion-content> -->\n<ion-footer>\n  <p><img src="../../assets/imgs/atc.jpg" /> Powered By ATC ONLINE</p>\n</ion-footer>\n'/*ion-inline-end:"/home/sushmitha/dontdelete/velan/medical-app/src/pages/student/stud-timetable/stud-timetable.html"*/
        }),
    ...
    return StudTimetablePage;
}());

//# sourceMappingURL=stud-timetable.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StudTimetablePageModule", function() { return StudTimetablePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stud_timetable__ = __webpack_require__(1054);
...
var StudTimetablePageModule = /** @class */ (function () {
    function StudTimetablePageModule() {
    }
    StudTimetablePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__stud_timetable__["a" /* StudTimetablePage */]],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__stud_timetable__["a" /* StudTimetablePage */]),
            ...
            exports: [__WEBPACK_IMPORTED_MODULE_2__stud_timetable__["a" /* StudTimetablePage */]]
        })
    ], StudTimetablePageModule);
    return StudTimetablePageModule;
}());

//# sourceMappingURL=stud-timetable.module.js.map
