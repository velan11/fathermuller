webpackJsonp([4],Array(501).concat([
/* 501 */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StudVideosPageModule", function() { return StudVideosPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__stud_videos__ = __webpack_require__(1053);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pipes_safepipe_safepipe__ = __webpack_require__(1054);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_in_app_browser_ngx__ = __webpack_require__(1015);
...
var StudVideosPageModule = /** @class */ (function () {
    function StudVideosPageModule() {
    }
    StudVideosPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__stud_videos__["a" /* StudVideosPage */], __WEBPACK_IMPORTED_MODULE_3__pipes_safepipe_safepipe__["a" /* SafepipePipe */]],
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__stud_videos__["a" /* StudVideosPage */])],
            providers: [__WEBPACK_IMPORTED_MODULE_4__ionic_native_in_app_browser_ngx__["a" /* InAppBrowser */]],
            exports: [__WEBPACK_IMPORTED_MODULE_2__stud_videos__["a" /* StudVideosPage */]]
        })
    ], StudVideosPageModule);
    return StudVideosPageModule;
}());

//# sourceMappingURL=stud-videos.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs__ = __webpack_require__(598);
...
var InAppBrowserObject = /** @class */ (function () {
    ...
    InAppBrowserObject.prototype.show = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__ionic_native_core__["cordovaInstance"])(this, "show", { "sync": true }, arguments); };
    InAppBrowserObject.prototype.close = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__ionic_native_core__["cordovaInstance"])(this, "close", { "sync": true }, arguments); };
    InAppBrowserObject.prototype.hide = function () { return Object(__WEBPACK_IMPORTED_MODULE_1__ionic_native_core__["cordovaInstance"])(this, "hide", { "sync": true }, arguments); };
    InAppBrowserObject.prototype.executeScript = function (script) { return Object(__WEBPACK_IMPORTED_MODULE_1__ionic_native_core__["cordovaInstance"])(this, "executeScript", {}, arguments); };
    InAppBrowserObject.prototype.insertCSS = function (css) { return Object(__WEBPACK_IMPORTED_MODULE_1__ionic_native_core__["cordovaInstance"])(this, "insertCSS", {}, arguments); };
    InAppBrowserObject.prototype.on = function (event) {
        var _this = this;
        return (function () {
            if (Object(__WEBPACK_IMPORTED_MODULE_1__ionic_native_core__["h" /* instanceAvailability */])(_this) === true) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return StudVideosPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_auth_service_auth_service__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_in_app_browser_ngx__ = __webpack_require__(1015);
 ...
 */
var StudVideosPage = /** @class */ (function () {
    function StudVideosPage(iab, navCtrl, navParams, service, sanitizer, loadingCtrl) {
        this.iab = iab;
    ...
    StudVideosPage.prototype.ionViewDidLoad = function () {
        this.getVediosInfo();
        console.log("ionViewDidLoad VideosPage");
    };
    StudVideosPage.prototype.openUrl = function () {
        window.open("https://www.youtube.com/embed/kEU9q1LOcI0", "_system");
    };
    StudVideosPage.prototype.getVediosInfo = function () {
        var _this = this;
        var loading = this.loadingCtrl.create({
            content: "Loading Please Wait..."
        });
        loading.present();
        this.service.getVedios().subscribe(function (data) {
            loading.dismiss();
            console.log(data);
            ...
            if (_this.data.data.length == 0) {
                ...
                _this.iframeURL = _this.data.data;
                console.log(_this.iframeURL);
                _this.vedioUrlArray = _this.data.data[0].videoList;
                console.log(_this.vedioUrlArray);
            }
        }, function (err) {
            loading.dismiss();
            console.log(err);
    ...
    StudVideosPage.prototype.back = function () {
        this.navCtrl.pop();
    };
    StudVideosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-stud-videos",template:/*ion-inline-start:"/home/sushmitha/dontdelete/velan/medical-app/src/pages/student/stud-videos/stud-videos.html"*/'<!--\n  Generated template for the StudVideosPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-toolbar>\n    <ion-buttons left>\n      <button ion-button icon-only menuToggle>\n        <ion-icon name="menu" style="color:white"></ion-icon>\n      </button>\n    </ion-buttons>\n\n    <ion-title> Videos</ion-title>\n    <ion-buttons right (click)="back()">\n      <button ion-button icon-only>\n        <ion-icon\n          ios="ios-arrow-back"\n          md="md-arrow-back"\n          style="color:white"\n        ></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content padding class="content-page">\n  <!-- <div *ngIf="noData" class="alert alert-danger">\n      {{ noDataValue }}\n    </div>\n    <ion-list>\n      <div *ngFor="let i of iframeURL">\n        <div class="card">\n          <ion-item>\n            <b>{{ i.videoList[0].videoTitle }}</b>\n            <div class="video-container">\n              <iframe\n                [src]="i.videoList[0].videoLink | safepipe"\n                frameborder="0"\n                width="560"\n                height="315"\n              ></iframe>\n            </div>\n          </ion-item>\n        </div>\n      </div>\n    </ion-list> -->\n  <ion-card>\n    <!-- <img src="../../../assets/imgs/notice- (1).jpg" /> -->\n    <div class="da">\n      <ion-card>\n        <h2 style="padding: 10px;">\n          Father Muller Charitable Institutions Documentary\n        </h2>\n        <a href="https://www.youtube.com/watch?v=YRPpm5npH1g">\n          <div class="cont">\n            <img\n              src="../../../assets/imgs/news.jpg"\n              alt="Snow"\n              style="width:100%;height: 100px;"\n            />\n\n            <div class="centered">\n              <img\n                src="../../../assets/imgs/utube.png"\n                width="55"\n                height="30"\n                alt="Snow"\n              />\n            </div>\n          </div>\n        </a>\n      </ion-card>\n\n      <ion-card>\n        <h2 style="padding: 10px;">\n          Father Muller College Nursing\n        </h2>\n        <a href="https://www.youtube.com/watch?v=D5s7HodEsVU">\n          <div class="cont">\n            <img\n              src="../../../assets/imgs/cvzx.png"\n              alt="Snow"\n              style="width:100%;height: 100px;"\n            />\n\n            <div class="centered">\n              <img\n                src="../../../assets/imgs/utube.png"\n                width="55"\n                height="30"\n                alt="Snow"\n              />\n            </div>\n          </div>\n        </a>\n      </ion-card>\n      <!-- <ion-card>\n        <div class="cont" (click)="openUrl()">\n          <img\n            src="../../../assets/imgs/news.jpg"\n            alt="Snow"\n            style="width:100%;"\n          />\n\n          <div class="centered">\n            <img src="../../../assets/imgs/utube.png" width="55"  height="30" alt="Snow" />\n          </div>\n        </div>\n      </ion-card> -->\n      <!-- https://www.bing.com/videos/search?q=fr+muller+mangalore+news&&view=detail&mid=C5AB417D737A699A5DC0C5AB417D737A699A5DC0&&FORM=VRDGAR -->\n    </div></ion-card\n  >\n  <!-- <div class="form-attendance">\n    <div *ngIf="NoInternet">\n      <b>No Internet Connection or Server Error. Try Again Later.</b>\n    </div>\n  </div> -->\n</ion-content>\n<ion-footer>\n  <p><img src="../../assets/imgs/atc.jpg" /> Powered By ATC ONLINE</p>\n</ion-footer>\n'/*ion-inline-end:"/home/sushmitha/dontdelete/velan/medical-app/src/pages/student/stud-videos/stud-videos.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__ionic_native_in_app_browser_ngx__["a" /* InAppBrowser */],
    ...
    return StudVideosPage;
}());

//# sourceMappingURL=stud-videos.js.map
