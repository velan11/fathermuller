...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1021).Buffer))
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FacAssignmentPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_quill__ = __webpack_require__(1014);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_quill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_quill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_js_quill_imageCompressor_js__ = __webpack_require__(1025);
...
__WEBPACK_IMPORTED_MODULE_3_quill__["register"]("modules/imageCompress", __WEBPACK_IMPORTED_MODULE_4__assets_js_quill_imageCompressor_js__["a" /* default */]);
var FacAssignmentPage = /** @class */ (function () {
    ...
    //   plugins: "fullscreen"
    // };
    function FacAssignmentPage(navCtrl, navParams, authFacService, loadingCtrl, app) {
        ...
        this.tday = new Date().toISOString().substring(0, 10);
        this.getCourse();
        this.startDate();
    }
    FacAssignmentPage.prototype.ionViewDidLoad = function () {
        console.log("ionViewDidLoad FacAssignmentsPage");
    };
    FacAssignmentPage.prototype.presentLoadingDefault = function () {
        this.loading = this.loadingCtrl.create({
            content: "Loading..."
        });
        this.loading.present();
    };
    FacAssignmentPage.prototype.onEditorContentChange = function (sdfa) {
        console.log(sdfa, "sdfa", sdfa.html);
        this.createAssignment.description = sdfa.html;
    };
    FacAssignmentPage.prototype.back = function () {
        this.navCtrl.setRoot("FacHomePage");
    };
    FacAssignmentPage.prototype.getCourse = function () {
        var _this = this;
        this.presentLoadingDefault();
        console.log("getCourse method");
        this.createAssignment.institution = JSON.parse(localStorage.getItem("institution_id"));
        ...
        localStorage.setItem("faculty_login_key", JSON.stringify(this.faculty_login_key1.faculty_login_key));
        ...
        var courseval = "student-attendance-get-course?institution_id=" +
            this.createAssignment.institution +
            "&faculty_login_key=" +
            this.faculty_login_key1.faculty_login_key;
        console.log("get course-", courseval);
        this.authFacService.getData(courseval).subscribe(function (data) {
            console.log(data);
            var result = JSON.parse(data._body);
            _this.responseData = result;
            console.log(_this.responseData);
            console.log("course list", _this.responseData.course_list);
            console.log("faculty id", _this.responseData.faculty_id);
            localStorage.setItem("getStudents.faculty_id", _this.responseData.faculty_id);
            // console.log("faculty id",this.faculty_id);
            if (_this.responseData.course_list) {
                _this.loading.dismiss();
                _this.course_list = _this.responseData.course_list;
            }
            else {
    ...
    FacAssignmentPage.prototype.getCoursePeriod = function () {
        var _this = this;
        this.presentLoadingDefault();
        ...
        // console.log("Institution Id: ", this.createAssignment.institution);
        var periodval = "faculty-app-get-course-period?institution=" +
            this.createAssignment.institution +
            "&course=" +
        ...
        this.authFacService.getData(periodval).subscribe(function (data) {
            console.log(data);
            var result = JSON.parse(data._body);
            _this.responseData = result;
            console.log("response courseperiod: ", _this.responseData.coursePeriod);
            if (_this.responseData.coursePeriod) {
                _this.loading.dismiss();
                for (var key in _this.responseData.coursePeriod) {
                    _this.coursePeriod.push({
                        key: key,
                        value: _this.responseData.coursePeriod[key]
                    });
                }
                console.log("coursePeriod:", _this.coursePeriod);
            ...
            if (err.status === 500) {
                alert("Something went wrong!! Login Again!!");
                _this.navCtrl.setRoot("FacAssignmentPage");
                // redirect to the login route
                // or show a modal
            }
        });
    };
    FacAssignmentPage.prototype.getSubject = function () {
        var _this = this;
        // this.presentLoadingDefault();
        console.log("getSubject method");
        console.log("Period Id: ", this.createAssignment.period);
        this.subject_details = [];
        localStorage.setItem("getStudents.period", JSON.stringify(this.createAssignment.period));
        console.log(this.createAssignment.period);
        // this.createAssignment.institution = localStorage.getItem("institution_id");
        // console.log("Institution Id: ", this.createAssignment.institution);
        var subjectval = "faculty-app-course-subject-details?institution=" +
            this.createAssignment.institution +
            "&course=" +
            this.createAssignment.course +
            "&period=" +
        ...
        this.authFacService.getData(subjectval).subscribe(function (data) {
            console.log(data);
            var result = JSON.parse(data._body);
            _this.responseData = result;
            if (_this.responseData.subject_details) {
                _this.loading.dismiss();
            }
            console.log(_this.responseData);
            if (_this.responseData) {
                for (var key in _this.responseData) {
                    console.log(_this.responseData[key], " this.responseData[key]");
                    if (_this.responseData[key] == "EVS") {
                        console.log(_this.responseData[key], " this.responseData[123]");
                        _this.subject_details.push({
                            key: key,
                            value: _this.responseData[key]
                        });
                    }
    ...
    FacAssignmentPage.prototype.getBatch = function () {
        var _this = this;
        this.presentLoadingDefault();
        console.log("getBatch method");
        console.log(this.createAssignment.subject);
        this.section_details = [];
        localStorage.setItem("createAssignment.subject", JSON.stringify(this.createAssignment.subject));
        console.log(this.createAssignment.subject);
        console.log("Course Id: ", this.createAssignment.course);
        console.log("period Id: ", this.createAssignment.period);
        var subjectval = "faculty-app-subject-section-details?institution=" +
            this.createAssignment.institution +
            "&course=" +
            this.createAssignment.course +
            "&period=" +
        ...
        this.authFacService.getData(subjectval).subscribe(function (data) {
            ...
            _this.responseData = result;
            console.log(_this.responseData);
            console.log(_this.responseData.section_details);
            if (_this.responseData.section_details) {
                _this.loading.dismiss();
                for (var key in _this.responseData.section_details) {
                    _this.section_details.push({
                        key: key,
                        value: _this.responseData.section_details[key]
                    });
                }
                _this.hideMe = true;
                // this.startDate();
    ...
    FacAssignmentPage.prototype.startDate = function () {
    ...
    FacAssignmentPage.prototype.getStartDate = function () {
        var dateData1 = this.createAssignment.startDate.split("-");
        var year1 = dateData1[0];
        var month1 = dateData1[1];
        var day1 = dateData1[2];
        this.createAssignment.startDate = day1 + "/" + month1 + "/" + year1;
    };
    FacAssignmentPage.prototype.getExpirydate = function () {
        console.log("tday: ", this.createAssignment.expiryDate);
        var dateData1 = this.createAssignment.expiryDate.split("-");
        var year1 = dateData1[0];
        var month1 = dateData1[1];
        var day1 = dateData1[2];
        this.createAssignment.expiryDate = day1 + "/" + month1 + "/" + year1;
    };
    FacAssignmentPage.prototype.createAssignments = function () {
        var _this = this;
        this.presentLoadingDefault();
        ...
        this.authFacService
            ...
            if (_this.responseData) {
                ...
                _this.navCtrl.push("FacAssignmentStudListPage", {
                    AssignmentStudentsDetails: _this.responseData,
...
//# sourceMappingURL=fac-assignment.js.map
...
var base64 = __webpack_require__(1022)
var ieee754 = __webpack_require__(1023)
var isArray = __webpack_require__(1024)
...
"use strict";
/* unused harmony export QUILL_CONFIG_TOKEN */
...
/* unused harmony export defaultModules */
...
var QUILL_CONFIG_TOKEN = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["InjectionToken"]('config');
...
var QuillEditorComponent = /** @class */ (function () {
    ...
    platformId, renderer, zone, config) {
        ...
        this.onEditorCreated = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["EventEmitter"]();
        this.onContentChanged = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["EventEmitter"]();
        this.onSelectionChanged = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["EventEmitter"]();
        this.onFocus = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["EventEmitter"]();
        this.onBlur = new __WEBPACK_IMPORTED_MODULE_1__angular_core__["EventEmitter"]();
        ...
        this.valueSetter = function (quillEditor, value) {
            if (_this.format === 'html') {
                if (_this.sanitize) {
                    value = _this.domSanitizer.sanitize(__WEBPACK_IMPORTED_MODULE_1__angular_core__["SecurityContext"].HTML, value);
                }
    ...
    QuillEditorComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        if (Object(__WEBPACK_IMPORTED_MODULE_2__angular_common__["j" /* isPlatformServer */])(this.platformId)) {
            return;
        }
        if (!Quill) {
            Quill = __webpack_require__(1014);
        }
        ...
        if (this.content) {
            if (this.format === 'object') {
                ...
                if (this.sanitize) {
                    this.content = this.domSanitizer.sanitize(__WEBPACK_IMPORTED_MODULE_1__angular_core__["SecurityContext"].HTML, this.content);
                }
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __decorate */])([
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["d" /* __metadata */])("design:type", String)
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __decorate */])([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
        Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["d" /* __metadata */])("design:type", Boolean)
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __decorate */])([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
        Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["d" /* __metadata */])("design:type", Number)
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __decorate */])([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Input"])(),
        Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["d" /* __metadata */])("design:type", Array)
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __decorate */])([
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["d" /* __metadata */])("design:type", __WEBPACK_IMPORTED_MODULE_1__angular_core__["EventEmitter"])
    ...
    QuillEditorComponent = QuillEditorComponent_1 = Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __decorate */])([
            ...
            providers: [
                {
                    ...
                    useExisting: Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["forwardRef"])(function () { return QuillEditorComponent_1; })
                },
                {
                    multi: true,
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __param */])(2, Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_2__angular_common__["c" /* DOCUMENT */])),
        Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __param */])(3, Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Inject"])(__WEBPACK_IMPORTED_MODULE_1__angular_core__["PLATFORM_ID"])),
        Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["e" /* __param */])(6, Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Inject"])(QUILL_CONFIG_TOKEN)),
        Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["d" /* __metadata */])("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["ElementRef"],
            __WEBPACK_IMPORTED_MODULE_3__angular_platform_browser__["c" /* DomSanitizer */], Object, Object,
            __WEBPACK_IMPORTED_MODULE_1__angular_core__["Renderer2"],
            __WEBPACK_IMPORTED_MODULE_1__angular_core__["NgZone"], Object])
...
var QuillModule = /** @class */ (function () {
    ...
    var QuillModule_1;
    QuillModule = QuillModule_1 = Object(__WEBPACK_IMPORTED_MODULE_0_tslib__["b" /* __decorate */])([
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FacAssignmentPageModule", function() { return FacAssignmentPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__fac_assignment__ = __webpack_require__(1020);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_quill__ = __webpack_require__(1026);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FacAssignmentPageModule = /** @class */ (function () {
    function FacAssignmentPageModule() {
    }
    FacAssignmentPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_2__fac_assignment__["a" /* FacAssignmentPage */]],
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__fac_assignment__["a" /* FacAssignmentPage */]), __WEBPACK_IMPORTED_MODULE_3_ngx_quill__["a" /* QuillModule */]],
            exports: [__WEBPACK_IMPORTED_MODULE_2__fac_assignment__["a" /* FacAssignmentPage */]]
        })
    ], FacAssignmentPageModule);
    return FacAssignmentPageModule;
}());

//# sourceMappingURL=fac-assignment.module.js.map
